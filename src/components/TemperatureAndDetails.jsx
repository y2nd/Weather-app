        ...
        <div className="flex flex-row items-center justify-between text-white py-3">
            ...
            <div className="flex flex-col space-y-2">
                ...
                <div className="flex font-light items-center text-sm justify-center">
                    ...
                    Real fell:
                    <span className="font-meduim ml-1">{`${feels_like.toFixed()}°`}</span>
                </div>

                <div className="flex font-light items-center text-sm justify-center">
                    <UilTear size={18} className="mr-1"/>
                    Humidity:
                    <span className="font-meduim ml-1">{`${humidity.toFixed()} %`}</span>
                </div>

                <div className="flex font-light items-center text-sm justify-center">
                    <UilWind size={18} className="mr-1"/>
                    Wind :
                    <span className="font-meduim ml-1">{`${speed.toFixed()} km/h`}</span>
                </div>
