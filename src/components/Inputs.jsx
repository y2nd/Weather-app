  ...
  return (
    <div className="flex flex-row justify-center my-6">
        ...
        <div className="flex flex-row w-1/4 items-center justify-center ">
            <button onClick={() => setUnits("metric")} name="metric" className="text-xl text-white font-light transition ease-out hover:scale-125">°C</button>
            <span className="text-xl text-white mx-1" >|</span>
            <button onClick={() => setUnits("imperial")} name="imperial" className="text-xl text-white font-light transition ease-out hover:scale-125">°F</button>
        </div>
